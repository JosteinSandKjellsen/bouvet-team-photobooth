...
- For implemented camera features, use the
  [required camera scenarios](../../docs/camera-and-initial-image-playbook.md#required-tests).
  For provider features, use the
  [Leonardo constraints](../../docs/leonardo-integration-playbook.md#harness-rules).
  For database/jobs work, use the
  [persistence checklist](../../docs/prisma-data-and-jobs-playbook.md#15-verification-checklist).
